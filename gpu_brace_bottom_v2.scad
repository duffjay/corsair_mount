...
difference () {
    ...
    union () {
        ...
        cube([male_x + 2 * flange_x, 6, 5], center = false);
    ...
    // hole in base plate
    translate([base_length/2 - (male_x/2 + flange_x), base_width/2 - flange_y/2, 0])
    cube([male_x + 2 * flange_x, flange_y, base_thickness], center = false);
